          ...
          <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-9">
                            <h5 class="card-title">Edit Perencanaan Audit</h5>
                        </div>
                    </div>
                  ...
                  <form action="/audit/update" method="post">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="tujuan_audit" placeholder="Masukan Tujuan Audit" value="{{ $a->tujuan_audit }}" required>
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Ruang Lingkup</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="ruang_lingkup" placeholder="Masukan Ruang Lingkup" value="{{ $a->ruang_lingkup }}" required>
                        </div>
                      </div>
                      <div class="row mb-3">
                          <label for="inputEmail" class="col-sm-2 col-form-label">Tim Audit</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="tim_audit" placeholder="Masukan Tim Audit" value="{{ $a->tim_audit }}" required>
                          </div>
                        </div>
                      <div class="row mb-3">
                          <label for="inputDate" class="col-sm-2 col-form-label">Tanggal Mulai</label>
                          <div class="col-sm-10">
                            <input type="date" class="form-control" name="tgl_mulai" required value="{{ $a->tgl_mulai }}">
                          </div>
                      </div>
                      <div class="row mb-3">
                          <label for="inputDate" class="col-sm-2 col-form-label">Tanggal Selesai</label>
                          <div class="col-sm-10">
                            <input type="date" class="form-control" name="tgl_selesai" required value="{{ $a->tgl_selesai }}">
                          </div>
                      </div>
                      <div class="row mb-3">
                          <label for="inputEmail" class="col-sm-2 col-form-label">Sumber Daya</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="sumber_daya" placeholder="Masukan Sumber Daya" value="{{ $a->sumber_daya }}">
                          </div>
                      </div>
                      <div class="row mb-3">
                          <label for="inputEmail" class="col-sm-2 col-form-label">Teknik Audit</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="teknik_audit" placeholder="Masukan Teknik Audit" required value="{{ $a->teknik_audit }}">
                          </div>
                      </div>
                      <div class="row mb-3">
